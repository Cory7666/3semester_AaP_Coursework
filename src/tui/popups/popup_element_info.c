            ...
            case MKEY_ENTER:
                switch (selected_field)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        tui_draw_popup_form (L"Ввод ареала", L"Введите ареал обитания животного.", L"ареал", edata->animal.areal, ANIMAL_AREAL_MAX_LEN, VMASK_ANY_CHAR);
                        break;
                    case 4:
                        tui_draw_popup_form (L"Ввод породы", L"Введите породу животного.", L"порода", edata->animal.breed, ANIMAL_BREED_MAX_LEN, VMASK_ANY_CHAR);
                        break;
                    case 5:
                        tui_draw_popup_form (L"Ввод имени", L"Введите имя животного.", L"имя", edata->animal.name, ANIMAL_NAME_MAX_LEN, VMASK_ANY_CHAR);
                        break;
                    case 6:
                        tui_draw_popup_form (L"Ввод типа продукта", L"Введите тип продукта.", L"тип", edata->products.type, PRODUCT_TYPE_MAX_LEN, VMASK_ANY_CHAR);
                        break;
                    case 7:
                        memset (tmp_wcs, 0, sizeof(tmp_wcs));
...
int tui_popup_show_only_element (const wchar_t * title, const list_elem_t * elem)
{
    ...
    do
    {
        ...
        mvwprintw (popup_win, 18, 1, "[E] Выйти.");
